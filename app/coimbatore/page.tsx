    ...
    <div className="min-h-screen bg-slate-50 text-brand-navy flex flex-col font-inter relative select-none font-medium text-base antialiased">
      ...
      <section id="hero" className="relative min-h-[100vh] w-full flex flex-col items-center justify-start pt-16 sm:pt-24 md:pt-28 pb-30 overflow-hidden text-white">
        ...
        <div className="relative z-20 flex flex-col items-center text-center px-4 sm:px-6 lg:px-8 max-w-7xl mt-8 mx-auto w-full">
          ...
          <p className="text-slate-200 text-sm sm:text-base md:text-lg font-normal leading-relaxed max-w-3xl mb-6">
            Strategically located across Coimbatore, Covai Tech Park offers premium workspaces in well-connected business hubs, providing easy access to major roads, IT corridors, and essential amenities. Each location is designed to deliver a productive and convenient work environment for businesses of all sizes.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-outfit font-bold text-brand-navy tracking-tight leading-none">
              Premium Workspaces in <br className="hidden sm:inline" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 xl:gap-10 mt-8 sm:mt-16 max-w-7xl mx-auto px-4 lg:px-0">
            ...
            <div className="group relative bg-white rounded-[2rem] overflow-hidden shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] transition-all duration-500 border border-slate-100 flex flex-col transform hover:-translate-y-2">
              ...
              <div className="p-6 md:p-8 flex flex-col flex-1 relative z-10 bg-white">
                <h3 className="text-xl md:text-2xl font-outfit font-bold text-brand-navy mb-2 group-hover:text-brand-orange transition-colors duration-300">Covai Tech Park, Nehru Nagar (SITRA)</h3>
                <p className="text-slate-500 font-medium text-xs mb-6 flex items-start gap-1.5">
                  ...
                  <span className="line-clamp-2 leading-relaxed">4th South Cross St, Kovai Thirunagar, Nehru Nagar East, Coimbatore- 641 014.</span>
                </p>
                <div className="space-y-3 mb-8 flex-1">
                  <div className="flex items-start gap-2.5">
                    ...
                    <p className="text-slate-600 text-[13px] leading-relaxed">Conveniently situated just off Avinashi Road, offering smooth city-wide connectivity</p>
                  </div>
                  <div className="flex items-start gap-2.5">
                    <div className="w-5 h-5 rounded-full bg-brand-orange/10 flex items-center justify-center shrink-0 mt-0.5 group-hover:bg-brand-orange/20 transition-colors">
                      <span className="text-brand-orange text-[10px]">✓</span>
                    </div>
                    <p className="text-slate-600 text-[13px] leading-relaxed">Surrounded by a rapidly developing neighborhood with modern infrastructure</p>
                  </div>
                  <div className="flex items-start gap-2.5">
                    <div className="w-5 h-5 rounded-full bg-brand-orange/10 flex items-center justify-center shrink-0 mt-0.5 group-hover:bg-brand-orange/20 transition-colors">
                      <span className="text-brand-orange text-[10px]">✓</span>
                    </div>
                    <p className="text-slate-600 text-[13px] leading-relaxed">Peaceful and secure environment ideal for daily office operations</p>
                  </div>
                </div>
            ...
            <div className="group relative bg-white rounded-[2rem] overflow-hidden shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] transition-all duration-500 border border-slate-100 flex flex-col transform hover:-translate-y-2">
              ...
              <div className="p-6 md:p-8 flex flex-col flex-1 relative z-10 bg-white">
                <h3 className="text-xl md:text-2xl font-outfit font-bold text-brand-navy mb-2 group-hover:text-brand-orange transition-colors duration-300">Covai Tech Park - Sunvale, Saravanampatti</h3>
                <p className="text-slate-500 font-medium text-xs mb-6 flex items-start gap-1.5">
                  <svg className="w-4 h-4 shrink-0 text-brand-orange mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.243-4.243a8 8 0 1111.314 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                  <span className="line-clamp-2 leading-relaxed">D.No. 46/6B-1, Sathy Road, North, Saravanampatti, Coimbatore, Tamil Nadu 641035.</span>
                </p>
                <div className="space-y-3 mb-8 flex-1">
                  <div className="flex items-start gap-2.5">
                    <div className="w-5 h-5 rounded-full bg-brand-orange/10 flex items-center justify-center shrink-0 mt-0.5 group-hover:bg-brand-orange/20 transition-colors">
                    ...
                    <p className="text-slate-600 text-[13px] leading-relaxed">Prime location along Sathy Road, one of Coimbatore’s major arterial routes</p>
                  </div>
                  <div className="flex items-start gap-2.5">
                    <div className="w-5 h-5 rounded-full bg-brand-orange/10 flex items-center justify-center shrink-0 mt-0.5 group-hover:bg-brand-orange/20 transition-colors">
                      <span className="text-brand-orange text-[10px]">✓</span>
                    </div>
                    <p className="text-slate-600 text-[13px] leading-relaxed">Seamless access to key IT tech and business zones throughout Saravanampatti</p>
                  </div>
                  <div className="flex items-start gap-2.5">
                    <div className="w-5 h-5 rounded-full bg-brand-orange/10 flex items-center justify-center shrink-0 mt-0.5 group-hover:bg-brand-orange/20 transition-colors">
                      <span className="text-brand-orange text-[10px]">✓</span>
                    </div>
                    <p className="text-slate-600 text-[13px] leading-relaxed">Located in a well-developed area with strong commercial and residential presence</p>
                  </div>
                </div>
                <div className="flex flex-col sm:flex-row gap-3 mt-auto">
