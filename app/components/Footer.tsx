  ...
  return (
    <footer className="w-full bg-[#060c10] text-white border-t border-white/5 font-sans z-10 relative">
      ...
      <div className="border-b border-white/35 py-6 sm:py-8">
        <div className="box-container flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6">
          <div className="text-left space-y-1">
            ...
            <p className="text-white/45 text-sm font-normal">Flexible tech workspaces in Coimbatore &amp; Trichy</p>
          </div>
          <button
      ...
      <div className="box-container py-14 grid grid-cols-1 md:grid-cols-12 gap-10">
        ...
        <div className="space-y-6 md:col-span-6 text-left">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-white/45 text-sm font-normal leading-relaxed max-w-md">
            ...
            <div>
              ...
              <a href={`mailto:${settings.email}`} className="text-white/45 hover:text-brand-orange text-sm font-normal transition-colors whitespace-nowrap">
                {settings.email}
              </a>
            </div>
          </div>
        ...
        <div className="space-y-5 md:col-span-3 text-left">
          ...
          <ul className="space-y-3 text-sm font-normal text-white/45">
            {[
              { name: "Coworking Space", link: prefix("/#services-dark") },
          ...
          <div className="">
            ...
            <div className="flex flex-col gap-1.5 text-white/45 text-sm font-normal">
              <a href={`tel:${settings.coimbatore_phone_raw}`} className="hover:text-brand-orange transition-colors whitespace-nowrap">{settings.coimbatore_phone_display}</a>
              <a href={`tel:${settings.trichy_phone_raw}`} className="hover:text-brand-orange transition-colors whitespace-nowrap">{settings.trichy_phone_display}</a>
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-white/5 py-5">
        <div className="box-container flex items-center justify-center text-center text-sm sm:text-sm font-medium text-white/60 px-2">
