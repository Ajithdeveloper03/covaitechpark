      ...
      >
        ...
        <div className="relative z-10 lg:w-1/2 text-left flex flex-col items-start gap-6">
          ...
          <p className="text-slate-300 text-sm sm:text-base leading-relaxed max-w-xl font-normal">
            Book fully equipped executive meeting spaces, conference boardrooms, and private interview slots hourly or daily. Fully managed, with smart display monitors, video conference AV, and on-site hospitality.
          </p>
