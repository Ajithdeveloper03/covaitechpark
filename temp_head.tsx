...
// Dual feature cards ΓÇö image overlay layout (reference: solar showcase)
const FEATURE_SHOWCASE_CARDS = [
  ...
  },
  {
    ...
    description:
      "Lockable cabin suites and hot desks on one campus ΓÇö use the same address for GST, meetings, and day-to-day engineering under one roof.",
...
export default function Home() {
  ...
  // Phases stacked scroll ΓÇö active slide index
  ...
  return (
    <div className="min-h-screen bg-white text-brand-navy flex flex-col font-inter relative select-none font-bold text-base">
      ...
      {/* VERTICAL SCROLL NAVIGATION TIMELINE ΓÇö hidden on hero, visible from 2nd section */}
      <div
      ...
      >
        <div className="w-full section-x flex justify-between items-center gap-3 sm:gap-4">
          ...
          >
            <div className="relative group cursor-pointer">
              <a href="#services-dark" className="hover:text-brand-orange transition-colors flex items-center gap-1">Services <span className="text-[8px]">Γû╝</span></a>
        ...
        {/* Mobile menu drawer ΓÇö side drawer layout */}
      ...
      <section id="hero" className="relative min-h-[100dvh] sm:h-screen w-full flex flex-col justify-center lg:justify-center pt-[4.5rem] sm:pt-20 pb-5 sm:pb-8 lg:pb-0 overflow-hidden bg-brand-navy text-white herosmall" >
        ...
        <div className="w-full section-x grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-20 lg:flex-1">
          ...
          {/* Slide thumbnails ΓÇö vertical list with vertical dot line on desktop */}
      ...
      {/* LOCATIONS SECTION ΓÇö Reference Image Style */}
      <section id="locations" className="w-full bg-white border-t border-slate-100 overflow-hidden">
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-0 items-stretch">
          ...
          <div className="col-span-1 lg:col-span-7 xl:col-span-7 pl-4 sm:pl-6 md:pl-10 lg:pl-12 xl:pl-16 pr-4 sm:pr-6 md:pr-10 lg:pr-12 xl:pr-16 py-16 sm:py-20 lg:py-24 space-y-8 relative z-10">
            ...
            {/* City Icon Grid ΓÇö reference style with circular borders & realistic icons */}
              ...
              {CITIES.map((city) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* City name ΓÇö normal weight, bold only when active */}
                    <span
            ...
            >
              View All Locations <span className="text-base">ΓåÆ</span>
            </button>
          </div>
          ...
          <div className="col-span-1 lg:col-span-5 xl:col-span-5 relative w-full min-h-[400px] sm:min-h-[500px] lg:min-h-0 lg:h-full">
            <div className="relative w-full h-full lg:absolute lg:inset-0 overflow-hidden ">
              ...
              {/* Active city badge ΓÇö top left */}
              ...
              {/* Call/enquiry floating button ΓÇö bottom right */}
              <button
                onClick={() => handleOpenBooking(`Enquiry ΓÇö ${activeCity}`)}
  ...
  {/* WE ARE HERE ΓÇö Minimal neon gradient + feature cards */}
  <section
        id="feature-showcase"
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="text-center mb-8 sm:mb-12 lg:mb-14 reveal reveal-up px-1">
            ...
            <h2 className="font-outfit font-bold text-xl sm:text-2xl md:text-3xl lg:text-[2.5rem] text-white/95 text-center leading-[1.2] tracking-tight max-w-3xl mx-auto">
              Supporting your workspace ambitions ΓÇö from your first desk to a full tech floor.
            </h2>
          </div>
      ...
      {/* ABOUT COMPANY SECTION ΓÇö NATURAL LAYOUT */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              <div className="flex flex-col justify-center space-y-6 sm:space-y-8">
                ...
                <p className="text-slate-600 text-base sm:text-lg leading-relaxed max-w-lg">
                  Founded in 2017, CovaiTech Park bridges the gap between high-cost commercial offices and flexible shared suites ΓÇö operating in Saravanampatti &amp; Nehru Nagar East, Coimbatore and Thillai Nagar, Trichy.
                </p>
 ...
 {/* SERVICES GRID (Image 4 Style - 100vh) */}
      ...
      {/* WORKSPACES ΓÇö mobile: full scrollable cards | desktop: sticky stacked scroll */}
...
{/* TESTIMONIALS SECTION ΓÇö Background image + overlay */}
        ...
        <div className="w-full flex flex-col items-center relative z-10">
          ...
          <div className="box-container text-center max-w-3xl space-y-4 mb-12 reveal reveal-up">
            ...
            <p className="text-slate-500 text-base sm:text-lg leading-relaxed max-w-xl mx-auto">
              A virtual tour of our live campuses ΓÇö from acoustic private cabins to premium collaborative lounges.
            </p>
          </div>
      ...
      <footer className="w-full bg-[#060c10] text-white border-t border-white/5">
        ...
        <div className="border-t border-white/5 py-5">
          <div className="box-container flex items-center justify-center text-center text-xs sm:text-sm font-bold text-white/60 px-2">
            <span>┬⌐ {new Date().getFullYear()} Covai Tech Park ΓÇö MAX OFFICE. All rights reserved.</span>
          </div>
        </div>
